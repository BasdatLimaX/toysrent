    ...
    <body>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('admin/read/'.$admin->no_ktp),'Read'); 
				echo ' | '; 
				echo anchor(site_url('admin/update/'.$admin->no_ktp),'Update'); 
				echo ' | '; 
				echo anchor(site_url('admin/delete/'.$admin->no_ktp),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
