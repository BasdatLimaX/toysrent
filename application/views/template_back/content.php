    ...
    <div class="scrollbar-inner">
      ...
      <div class="sidenav-header d-flex align-items-center">
        <a class="navbar-brand" href="dashboard.html">
          <img src="<?php echo base_url('assets/argonpanel/assets/img/brand/blue.png') ?>" class="navbar-brand-img" alt="...">
        </a>
        <div class="ml-auto">
          <!-- Sidenav toggler -->
                ...
                <div class="list-group list-group-flush">
                  <a href="#!" class="list-group-item list-group-item-action">
                    <div class="row align-items-center">
                      <div class="col-auto">
                        <!-- Avatar -->
                        <img alt="Image placeholder" src="<?php echo base_url('assets/argonpanel/assets/img/theme/team-1.jpg') ?>" class="avatar rounded-circle">
                      </div>
                      <div class="col ml--2">
                  ...
                  <a href="#!" class="list-group-item list-group-item-action">
                    <div class="row align-items-center">
                      <div class="col-auto">
                        <!-- Avatar -->
                        <img alt="Image placeholder" src="<?php echo base_url('assets/argonpanel/assets/img/theme/team-2.jpg') ?>" class="avatar rounded-circle">
                      </div>
                      <div class="col ml--2">
                        <div class="d-flex justify-content-between align-items-center">
                          <div>
                  ...
                  <a href="#!" class="list-group-item list-group-item-action">
                    <div class="row align-items-center">
                      <div class="col-auto">
                        <!-- Avatar -->
                        <img alt="Image placeholder" src="<?php echo base_url('assets/argonpanel/assets/img/theme/team-3.jpg') ?>" class="avatar rounded-circle">
                      </div>
                      <div class="col ml--2">
                        <div class="d-flex justify-content-between align-items-center">
                          <div>
                  ...
                  <a href="#!" class="list-group-item list-group-item-action">
                    <div class="row align-items-center">
                      <div class="col-auto">
                        <!-- Avatar -->
                        <img alt="Image placeholder" src="<?php echo base_url('assets/argonpanel/assets/img/theme/team-4.jpg') ?>" class="avatar rounded-circle">
                      </div>
                      <div class="col ml--2">
                        <div class="d-flex justify-content-between align-items-center">
                          <div>
                  ...
                  <a href="#!" class="list-group-item list-group-item-action">
                    <div class="row align-items-center">
                      <div class="col-auto">
                        <!-- Avatar -->
                        <img alt="Image placeholder" src="<?php echo base_url('assets/argonpanel/assets/img/theme/team-5.jpg') ?>" class="avatar rounded-circle">
                      </div>
                      <div class="col ml--2">
                        <div class="d-flex justify-content-between align-items-center">
                          <div>
              ...
              <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="media align-items-center">
                  <span class="avatar avatar-sm rounded-circle">
                    <img alt="Image placeholder" src="<?php echo base_url('assets/argonpanel/assets/img/theme/team-4.jpg') ?>">
                  </span>
                  ...
                  <div class="row align-items-center">
                    <div class="col-auto">
                      ...
                      <a href="#" class="avatar rounded-circle">
                        <img alt="Image placeholder" src="<?php echo base_url('assets/argonpanel/assets/img/theme/team-1.jpg') ?>">
                      </a>
                    </div>
                    <div class="col ml--2">
                      <h4 class="mb-0">
                ...
                <li class="list-group-item px-0">
                  <div class="row align-items-center">
                    <div class="col-auto">
                      <!-- Avatar -->
                      <a href="#" class="avatar rounded-circle">
                        <img alt="Image placeholder" src="<?php echo base_url('assets/argonpanel/assets/img/theme/team-2.jpg') ?>">
                      </a>
                    </div>
                    <div class="col ml--2">
                      <h4 class="mb-0">
                ...
                <li class="list-group-item px-0">
                  <div class="row align-items-center">
                    <div class="col-auto">
                      <!-- Avatar -->
                      <a href="#" class="avatar rounded-circle">
                        <img alt="Image placeholder" src="<?php echo base_url('assets/argonpanel/assets/img/theme/team-3.jpg') ?>">
                      </a>
                    </div>
                    <div class="col ml--2">
                      <h4 class="mb-0">
                ...
                <li class="list-group-item px-0">
                  <div class="row align-items-center">
                    <div class="col-auto">
                      <!-- Avatar -->
                      <a href="#" class="avatar rounded-circle">
                        <img alt="Image placeholder" src="<?php echo base_url('assets/argonpanel/assets/img/theme/bootstrap.jpg') ?>">
                      </a>
                    </div>
                    <div class="col">
                ...
                <li class="list-group-item px-0">
                  <div class="row align-items-center">
                    <div class="col-auto">
                      <!-- Avatar -->
                      <a href="#" class="avatar rounded-circle">
                        <img alt="Image placeholder" src="<?php echo base_url('assets/argonpanel/assets/img/theme/angular.jpg') ?>">
                      </a>
                    </div>
                    <div class="col">
                ...
                <li class="list-group-item px-0">
                  <div class="row align-items-center">
                    <div class="col-auto">
                      <!-- Avatar -->
                      <a href="#" class="avatar rounded-circle">
                        <img alt="Image placeholder" src="<?php echo base_url('assets/argonpanel/assets/img/theme/sketch.jpg') ?>">
                      </a>
                    </div>
                    <div class="col">
                ...
                <li class="list-group-item px-0">
                  <div class="row align-items-center">
                    <div class="col-auto">
                      <!-- Avatar -->
                      <a href="#" class="avatar rounded-circle">
                        <img alt="Image placeholder" src="<?php echo base_url('assets/argonpanel/assets/img/theme/react.jpg') ?>">
                      </a>
                    </div>
                    <div class="col">
          ...
          <div class="card">
            ...
            <div class="card-header d-flex align-items-center">
              <div class="d-flex align-items-center">
                <a href="#">
                  <img src="<?php echo base_url('assets/argonpanel/assets/img/theme/team-1.jpg') ?>" class="avatar">
                </a>
                <div class="mx-3">
            ...
            <div class="card-body">
              ...
              <img alt="Image placeholder" src="<?php echo base_url('assets/argonpanel/assets/img/theme/img-1-1000x600.jpg') ?>" class="img-fluid rounded">
                  ...
                  <div class="d-flex align-items-center justify-content-sm-end">
                    <div class="avatar-group">
                      <a href="#" class="avatar avatar-xs rounded-circle" data-toggle="tooltip" data-original-title="Jessica Rowland">
                        <img alt="Image placeholder" src="<?php echo base_url('assets/argonpanel/assets/img/theme/team-1.jpg') ?>" class="">
                      </a>
                      <a href="#" class="avatar avatar-xs rounded-circle" data-toggle="tooltip" data-original-title="Audrey Love">
                        <img alt="Image placeholder" src="<?php echo base_url('assets/argonpanel/assets/img/theme/team-2.jpg') ?>" class="rounded-circle">
                      </a>
                      <a href="#" class="avatar avatar-xs rounded-circle" data-toggle="tooltip" data-original-title="Michael Lewis">
                        <img alt="Image placeholder" src="<?php echo base_url('assets/argonpanel/assets/img/theme/team-3.jpg') ?>" class="rounded-circle">
                      </a>
                    </div>
              ...
              <div class="mb-1">
                <div class="media media-comment">
                  <img alt="Image placeholder" class="avatar avatar-lg media-comment-avatar rounded-circle" src="<?php echo base_url('assets/argonpanel/assets/img/theme/team-1.jpg') ?>">
                ...
                <div class="media media-comment">
                  <img alt="Image placeholder" class="avatar avatar-lg media-comment-avatar rounded-circle" src="<?php echo base_url('assets/argonpanel/assets/img/theme/team-2.jpg') ?>">
                  <div class="media-body">
                    <div class="media-comment-text">
                ...
                <hr />
                <div class="media align-items-center">
                  <img alt="Image placeholder" class="avatar avatar-lg rounded-circle mr-4" src="<?php echo base_url('assets/argonpanel/assets/img/theme/team-3.jpg') ?>">
                  <div class="media-body">
                    <form>
                    ...
                    <tbody class="list">
                      ...
                      <tr>
                        <th scope="row">
                          <div class="media align-items-center">
                            <a href="#" class="avatar rounded-circle mr-3">
                              <img alt="Image placeholder" src="<?php echo base_url('assets/argonpanel//assets/img/theme/vue.jpg') ?>">
                            </a>
                            <div class="media-body">
            ...
            <div class="card bg-gradient-danger">
              ...
              <div class="card-body">
                <div class="row justify-content-between align-items-center">
                  <div class="col">
                    <img src="<?php echo base_url('assets/argonpanel/assets/img/icons/cards/bitcoin.png') ?>" alt="Image placeholder" />
                  </div>
                  <div class="col-auto">
