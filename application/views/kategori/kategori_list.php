...
<html>
    ...
    <body>
		...
		<th>Action</th>
			...
			<td><?php echo $kategori->level ?></td>
			<td><?php echo $kategori->sub_dari ?></td>
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('kategori/read/'.$kategori->nama),'Read'); 
				echo ' | '; 
				echo anchor(site_url('kategori/update/'.$kategori->nama),'Update'); 
				echo ' | '; 
				echo anchor(site_url('kategori/delete/'.$kategori->nama),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
