...
<html>
    ...
    <body>
		...
		<th>Action</th>
			...
			<td><?php echo $anggota->poin ?></td>
			<td><?php echo $anggota->level ?></td>
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('anggota/read/'.$anggota->no_ktp),'Read'); 
				echo ' | '; 
				echo anchor(site_url('anggota/update/'.$anggota->no_ktp),'Update'); 
				echo ' | '; 
				echo anchor(site_url('anggota/delete/'.$anggota->no_ktp),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
