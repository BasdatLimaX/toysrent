...
class Kategori extends CI_Controller
{
    ...
    public function create_action() 
    {
		...
		'sub_dari' => $this->input->post('sub_dari',TRUE),
	    );
    ...
    public function update($id) 
    {
		...
		'sub_dari' => set_value('sub_dari', $row->sub_dari),
	    );
            $this->load->view('kategori/kategori_form', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
    ...
    public function update_action() 
    {
		...
		'sub_dari' => $this->input->post('sub_dari',TRUE),
            ...
            $this->Kategori_model->update($this->input->post('nama', TRUE), $data);
	...
	$this->form_validation->set_rules('sub_dari', 'sub dari', 'trim|required');
